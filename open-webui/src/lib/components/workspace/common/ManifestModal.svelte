				...
				>
					<div class="px-1 text-sm">
						...
						<div class="my-2">
							...
							{$i18n.t(
								'Your entire contribution will go directly to the plugin developer; Biz GPT does not take any percentage. However, the chosen funding platform might have its own fees.'
							)}
						</div>
