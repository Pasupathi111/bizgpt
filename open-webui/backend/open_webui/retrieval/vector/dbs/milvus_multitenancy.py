...
# can't be a legitimate Biz GPT collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current Biz GPT naming conventions for
        collection names. If Biz GPT changes how it generates collection names
